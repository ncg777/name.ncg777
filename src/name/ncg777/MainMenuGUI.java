...
public class MainMenuGUI {
  public static void main(String[] args) {
    ...
    addAppButton(panel, "maths.sentences.apps.BitCounter",name.ncg777.maths.phrases.apps.BitCounter.class);
    addAppButton(panel, "maths.sentences.apps.Diluter",name.ncg777.maths.phrases.apps.Diluter.class);
    addAppButton(panel, "maths.sentences.apps.FourCharsCalculator",name.ncg777.maths.phrases.apps.FourCharsCalculator.class);
    addAppButton(panel, "maths.sentences.apps.FourCharsMatrixGenerator",name.ncg777.maths.phrases.apps.FourCharsMatrixGenerator.class);
    addAppButton(panel, "maths.sentences.apps.FourCharsMerger",name.ncg777.maths.phrases.apps.FourCharsMerger.class);
    addAppButton(panel, "maths.sentences.apps.FourCharsPartitioner",name.ncg777.maths.phrases.apps.FourCharsPartitioner.class);
    addAppButton(panel, "maths.sentences.apps.HexadecimalWordDivider",name.ncg777.maths.phrases.apps.HexadecimalWordDivider.class);
    addAppButton(panel, "maths.sentences.apps.Permutator",name.ncg777.maths.phrases.apps.Permutator.class);
    addAppButton(panel, "maths.sentences.apps.Pulsations",name.ncg777.maths.phrases.apps.Pulsations.class);
    addAppButton(panel, "maths.sentences.apps.ScaleModulo",name.ncg777.maths.phrases.apps.ScaleModulo.class);
    addAppButton(panel, "maths.sentences.apps.SequenceGenerator",name.ncg777.maths.phrases.apps.SequenceGenerator.class);
    addAppButton(panel, "maths.sentences.apps.Sequencer",name.ncg777.maths.phrases.apps.Sequencer.class);
