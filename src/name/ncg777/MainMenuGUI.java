...
public class MainMenuGUI {
  public static void main(String[] args) {
    ...
    addAppButton(panel, "maths.pitchClassSet12.apps.Combiner", name.ncg777.maths.pitchClassSet12.apps.Combiner.class);
    addAppButton(panel, "maths.pitchClassSet12.apps.GraphExplorer", name.ncg777.maths.pitchClassSet12.apps.GraphExplorer.class);
    addAppButton(panel, "maths.pitchClassSet12.apps.Identifier", name.ncg777.maths.pitchClassSet12.apps.Identifier.class);
    addAppButton(panel, "maths.pitchClassSet12.apps.IntersectionAndUnion", name.ncg777.maths.pitchClassSet12.apps.IntersectionAndUnion.class);
    addAppButton(panel, "maths.pitchClassSet12.apps.KComplexExplorer", name.ncg777.maths.pitchClassSet12.apps.KComplexExplorer.class);
    addAppButton(panel, "maths.pitchClassSet12.apps.MatrixGenerator", name.ncg777.maths.pitchClassSet12.apps.MatrixGenerator.class);
    addAppButton(panel, "maths.pitchClassSet12.apps.Permutator", name.ncg777.maths.pitchClassSet12.apps.Permutator.class);
    addAppButton(panel, "maths.pitchClassSet12.apps.Permutator", name.ncg777.maths.pitchClassSet12.apps.Permutator.class);
    addAppButton(panel, "maths.pitchClassSet12.apps.RandomWalker1", name.ncg777.maths.pitchClassSet12.apps.RandomWalker1.class);
    addAppButton(panel, "maths.pitchClassSet12.apps.Rotator", name.ncg777.maths.pitchClassSet12.apps.Rotator.class);
    addAppButton(panel, "maths.pitchClassSet12.apps.SequenceMerger", name.ncg777.maths.pitchClassSet12.apps.SequenceMerger.class);
    addAppButton(panel, "maths.pitchClassSet12.apps.SequenceVisualizer", name.ncg777.maths.pitchClassSet12.apps.SequenceVisualizer.class);
    addAppButton(panel, "maths.pitchClassSet12.apps.Sorter", name.ncg777.maths.pitchClassSet12.apps.Sorter.class);
    addAppButton(panel, "maths.pitchClassSet12.apps.Walker", name.ncg777.maths.pitchClassSet12.apps.Walker.class);
    addAppButton(panel, "music.apps.ModularArithmeticSequencer", name.ncg777.music.apps.ModularArithmeticSequencer.class);
    addAppButton(panel, "music.apps.SeqGenBySegments", name.ncg777.music.apps.SeqGenBySegments.class);
    addAppButton(panel, "music.apps.SeqGenContourFollow", name.ncg777.music.apps.SeqGenContourFollow.class);
    addAppButton(panel, "music.apps.SeqGenFS", name.ncg777.music.apps.SeqGenFS.class);
    addAppButton(panel, "music.apps.SeqGenFixedSum", name.ncg777.music.apps.SeqGenFixedSum.class);
    addAppButton(panel, "music.apps.SequenceConvolverAbsoluteTime", name.ncg777.music.apps.SequenceConvolverAbsoluteTime.class);
    addAppButton(panel, "music.apps.XORCircularConvolver", name.ncg777.music.apps.XORCircularConvolver.class);
    addAppButton(panel, "music.apps.XRSequenceGenerator", name.ncg777.music.apps.XRSequenceGenerator.class);
    addAppButton(panel, "music.apps.x2mid", name.ncg777.music.apps.x2mid.class);
