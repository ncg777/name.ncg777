...
public class MainMenuGUI {
  public static void main(String[] args) {
    ...
    addAppButton(panel, "maths.numbers.quartal.apps.QuartalNumbersCalculator",name.ncg777.maths.numbers.quartal.apps.QuartalNumbersCalculator.class);
    addAppButton(panel, "maths.numbers.quartal.apps.QuartalNumbersMatrixGenerator",name.ncg777.maths.numbers.quartal.apps.QuartalNumbersMatrixGenerator.class);
    addAppButton(panel, "maths.numbers.quartal.apps.QuartalNumbersMatrixSequencer",name.ncg777.maths.numbers.quartal.apps.QuartalNumbersMatrixSequencer.class);
    addAppButton(panel, "maths.numbers.quartal.apps.QuartalNumbersMerger",name.ncg777.maths.numbers.quartal.apps.QuartalNumbersMerger.class);
    addAppButton(panel, "maths.numbers.quartal.apps.QuartalNumbersPartitioner",name.ncg777.maths.numbers.quartal.apps.QuartalNumbersPartitioner.class);
