...
public class MainMenuGUI {
  public static void main(String[] args) {
    ...
    addAppButton(panel, "Rhythm Explorer", name.ncg777.maths.numbers.fixed.rhythm.apps.RhythmExplorerGUI.class);
    ...
    addAppButton(panel, "maths.sequences.apps.Arp",name.ncg777.maths.sequences.apps.Arp.class);
