...
public class QuartalNumbersPartitioner {
  ...
  public static void main(String[] args) {
    EventQueue.invokeLater(new Runnable() {
      public void run() {
        try {
          QuartalNumbersPartitioner window = new QuartalNumbersPartitioner();
  ...
  public QuartalNumbersPartitioner() {
    initialize();
  }

  private void initialize() {
    frmRPartitioner = new JFrame();
    frmRPartitioner.setTitle("QuartalNumbersPartitioner");
