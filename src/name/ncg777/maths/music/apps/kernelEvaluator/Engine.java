...
public class Engine {
  ...
  public HomoPair<Sequence> evaluate(BinaryNatural binaryNatural, final String _parameters, String kernel) {
    return evaluate(binaryNatural, _parameters, KernelsByName.get(kernel));
  }
  
  public HomoPair<Sequence> evaluate(BinaryNatural binaryNatural, final String _parameters, Kernel kernel) {
    ...
    for(int hit : binaryNatural.reverse().asSequence()) {
