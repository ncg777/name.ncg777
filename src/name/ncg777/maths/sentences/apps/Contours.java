...
//      public void run() {
//        try {
//          RhythmContours window = new RhythmContours();
...
//          txtComposition.setText(r4.asWord().getComposition().toString());
//          textFieldBinary.setText(r4.asWord().asBinarySequence().toString());
...
//          
//          Sequence contourseq = r4.asWord().getContour().circularHoldNonZero().cyclicalAntidifference(0).asOrdinalsUnipolar().addToAll(-1);
//
