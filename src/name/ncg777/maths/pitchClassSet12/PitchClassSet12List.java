package name.ncg777.maths.pitchClassSet12;
...
public class PitchClassSet12List extends ArrayList<PitchClassSet12> {

  private static final long serialVersionUID = 1L;

  public PitchClassSet12List transpose(int n) {
    PitchClassSet12List o = new PitchClassSet12List();
  ...
  public static PitchClassSet12List parse(String s) {
    var ss = s.split("\\s+");
    PitchClassSet12List o = new PitchClassSet12List();
    for(String _s : ss) {
  ...
  public static PitchClassSet12List parseForte(String s) {
    var ss = s.split("\\s+");
    PitchClassSet12List o = new PitchClassSet12List();
    for(String _s : ss) {
  ...
  public static PitchClassSet12List merge(ArrayList<PitchClassSet12List> s) {
    int n = 1;
