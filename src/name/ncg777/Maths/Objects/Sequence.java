...
import name.ncg777.CS.DataStructures.IterableComparator;
...
public class Sequence extends ArrayList<Integer> implements Comparable<Sequence>, Serializable {
  ...
  */
   ...
   * 
   * @see name.ncg777.Maths.Objects.Sequence#mapOrdinalsUnipolar()
   * @return
   */
   ...
   * 
   * @see name.ncg777.Maths.Objects.Sequence#mapOrdinalsBipolar()
   * @return
   */
