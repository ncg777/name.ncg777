...
import name.ncg777.music.pitchClassSet12Predicates.Consonant;
import name.ncg777.music.pitchClassSet12Predicates.SubsetOf;
import name.ncg777.music.pitchClassSet12Relations.CloseIVs;
import name.ncg777.music.pitchClassSet12Relations.CommonNotesAtLeast;
import name.ncg777.music.pitchClassSet12Relations.Different;
import name.ncg777.music.pitchClassSet12Relations.IVEQRotOrRev;
import name.ncg777.music.pitchClassSet12Relations.PredicatedUnion;
...
public class PitchClassSet12Matrix {
  ...
  public static void main(String[] args) {
    EventQueue.invokeLater(new Runnable() {
      public void run() {
        try {
          PitchClassSet12Matrix window = new PitchClassSet12Matrix();
