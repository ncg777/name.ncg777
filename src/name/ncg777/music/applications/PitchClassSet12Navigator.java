...
import name.ncg777.music.pitchClassSet12Predicates.SupersetOf;
...
public class PitchClassSet12Navigator {
  ...
  public static void main(String[] args) {
    EventQueue.invokeLater(new Runnable() {
      public void run() {
        try {
          PitchClassSet12Navigator window = new PitchClassSet12Navigator();
   ...
   */
  public PitchClassSet12Navigator() {
    initialize();
    refreshAvailable();
    refreshButtons();
  }
