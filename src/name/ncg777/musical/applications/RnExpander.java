    ...
    btnExpand.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        if(comboBox.getSelectedItem() == Rn.Hex) {
          R16List o = R16List.rotate(R16List.expand(R16List.parseR16Seq(txtRhythm.getText()), (int)spinner.getValue(), chckbxFill.isSelected()), (int)rot.getValue());
          txtResult.setText(o.toString());
          txtNot.setText(R16List.not(o).toString());
