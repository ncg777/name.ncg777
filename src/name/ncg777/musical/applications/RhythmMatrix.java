...
import name.ncg777.musical.R12List;
import name.ncg777.musical.R16List;
import name.ncg777.musical.R48List;
import name.ncg777.musical.Rhythm;
import name.ncg777.musical.Rhythm12;
import name.ncg777.musical.Rhythm16;
import name.ncg777.musical.Rhythm48;
import name.ncg777.musical.Rn;
import name.ncg777.musical.rhythmPredicates.Bypass;
import name.ncg777.musical.rhythmPredicates.EntropicDispersion;
import name.ncg777.musical.rhythmPredicates.Even;
import name.ncg777.musical.rhythmPredicates.LowEntropy;
import name.ncg777.musical.rhythmPredicates.MaximumGap;
import name.ncg777.musical.rhythmPredicates.MinimumGap;
import name.ncg777.musical.rhythmPredicates.Oddity;
import name.ncg777.musical.rhythmPredicates.Ordinal;
import name.ncg777.musical.rhythmPredicates.RelativelyFlat;
import name.ncg777.musical.rhythmPredicates.SecondOrderDifferenceSum;
import name.ncg777.musical.rhythmPredicates.ShadowContourIsomorphic;
import name.ncg777.musical.rhythmPredicates.SpectrumRising;
import name.ncg777.musical.rhythmPredicates.SecondOrderDifferenceSum.Keep;
import name.ncg777.musical.rhythmRelations.PredicatedDifferences;
import name.ncg777.musical.rhythmRelations.PredicatedJuxtaposition;
          ...
          public void run() {
            try {
              ...
              if(comboBox.getSelectedItem().equals(Rn.Tribble)) {
                relSimul = new name.ncg777.musical.rhythmRelations.CompatibleRhythms();
              } else {
                relSimul = new name.ncg777.musical.rhythmRelations.Bypass();
              }
