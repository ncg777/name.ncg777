...
import name.ncg777.mathematics.enumerations.PermutationEnumeration;
...
public class Sequence extends ArrayList<Integer> implements Comparable<Sequence>, Serializable {
  ...
  */
   ...
   * 
   * @see name.ncg777.mathematics.objects.Sequence#mapOrdinalsUnipolar()
   * @return
   */
   ...
   * 
   * @see name.ncg777.mathematics.objects.Sequence#mapOrdinalsBipolar()
   * @return
   */
