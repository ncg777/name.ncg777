package name.ncg777.mathematics.applications;
...
import name.ncg777.mathematics.enumerations.WordPermutationEnumeration;
...
public class WordPermutator {
  ...
  public static void main(String[] args) {
    EventQueue.invokeLater(new Runnable() {
      public void run() {
        try {
          WordPermutator window = new WordPermutator();
  ...
  private void initialize() {
    ...
    frmWordPermutator.setTitle("Word Permutator");
