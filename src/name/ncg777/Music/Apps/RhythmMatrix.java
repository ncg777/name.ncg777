...
import name.ncg777.Music.Rhythm12;
import name.ncg777.Music.Rhythm16;
import name.ncg777.Music.Rhythm48;
import name.ncg777.Music.Rn;
import name.ncg777.Music.RhythmPredicates.Bypass;
import name.ncg777.Music.RhythmPredicates.EntropicDispersion;
import name.ncg777.Music.RhythmPredicates.Even;
import name.ncg777.Music.RhythmPredicates.LowEntropy;
import name.ncg777.Music.RhythmPredicates.MaximumGap;
import name.ncg777.Music.RhythmPredicates.MinimumGap;
import name.ncg777.Music.RhythmPredicates.Oddity;
import name.ncg777.Music.RhythmPredicates.Ordinal;
import name.ncg777.Music.RhythmPredicates.RelativelyFlat;
import name.ncg777.Music.RhythmPredicates.SecondOrderDifferenceSum;
import name.ncg777.Music.RhythmPredicates.ShadowContourIsomorphic;
import name.ncg777.Music.RhythmPredicates.SpectrumRising;
import name.ncg777.Music.RhythmPredicates.SecondOrderDifferenceSum.Keep;
import name.ncg777.Music.RhythmRelations.PredicatedDifferences;
import name.ncg777.Music.RhythmRelations.PredicatedJuxtaposition;
          ...
          public void run() {
            try {
              ...
              if(comboBox.getSelectedItem().equals(Rn.Tribble)) {
                relSimul = new name.ncg777.Music.RhythmRelations.CompatibleRhythms();
              } else {
                relSimul = new name.ncg777.Music.RhythmRelations.Bypass();
              }
