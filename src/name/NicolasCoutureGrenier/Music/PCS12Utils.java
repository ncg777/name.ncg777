...
public class PCS12Utils {
  ...
  public static JaggedArrayList<PCS12> randomChordTree(TreeSet<PCS12> t, Integer[] n, int nb) {
  ...
  private static JaggedArrayList<PCS12> randomChordTreeSub(JaggedArrayList<PCS12> parent, PCS12 z, Integer[] n,
      TreeSet<PCS12> t0, Predicate<PCS12> p, int nb) {
    JaggedArrayList<PCS12> o = new JaggedArrayList<PCS12>(z, parent);
