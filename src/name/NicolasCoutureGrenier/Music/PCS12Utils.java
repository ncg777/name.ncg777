...
public class PCS12Utils {
  ...
  public static JaggedArray<PCS12> randomChordTree(TreeSet<PCS12> t, Integer[] n, int nb) {
  ...
  private static JaggedArray<PCS12> randomChordTreeSub(JaggedArray<PCS12> parent, PCS12 z, Integer[] n,
      TreeSet<PCS12> t0, Predicate<PCS12> p, int nb) {
    JaggedArray<PCS12> o = new JaggedArray<PCS12>(z, parent);
