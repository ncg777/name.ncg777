...
import name.NicolasCoutureGrenier.Maths.DataStructures.IterableComparator;
import name.NicolasCoutureGrenier.Maths.DataStructures.Sequence;
import name.NicolasCoutureGrenier.Maths.Enumerations.BitSetEnumeration;
import name.NicolasCoutureGrenier.Maths.Enumerations.FixedSetPartitionEnumeration;
import name.NicolasCoutureGrenier.Music.RhythmPredicates.BypassPlain;
import name.NicolasCoutureGrenier.Music.RhythmPredicates.NoRepeat;
import name.NicolasCoutureGrenier.Music.RhythmPredicates.PredicatedPartition;
import name.NicolasCoutureGrenier.Music.RhythmPredicates.ShadowContourIsomorphic;
import name.NicolasCoutureGrenier.Music.RhythmPredicates.WellDistributed;
