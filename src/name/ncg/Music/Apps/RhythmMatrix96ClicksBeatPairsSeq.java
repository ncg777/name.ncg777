...
public class RhythmMatrix96ClicksBeatPairsSeq {
  ...
  public static void main(String[] args) {
    EventQueue.invokeLater(new Runnable() {
      public void run() {
        try {
          RhythmMatrix96ClicksBeatPairsSeq window = new RhythmMatrix96ClicksBeatPairsSeq();
   ...
   */
  public RhythmMatrix96ClicksBeatPairsSeq() {
    initialize();
  }
  ...
  private void initialize() {
    ...
    btnGenerate.addActionListener(new ActionListener() {
      public void actionPerformed(ActionEvent e) {
        ...
        for(int i=0;i<m;i++) {
          var a = MeasureRhythm.parseMeasureRhythm(r96str[i]).splitInPairs();
          int j=0;
