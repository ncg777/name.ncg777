...
import name.ncg.Maths.Enumerations.PermutationEnumeration;
...
public class Sequence extends ArrayList<Integer> implements Comparable<Sequence>, Serializable {
   ...
   * 
   * @see name.ncg.Maths.DataStructures.Sequence#mapOrdinalsUnipolar()
   * @return
   */
   ...
   * 
   * @see name.ncg.Maths.DataStructures.Sequence#mapOrdinalsBipolar()
   * @return
   */
